// KDTreeRadar.cs - A Stark, September 2009.
...
public class KDTreeRadar {
	
	public KDTreeRadar[] lr;
...
//	be quicker in two dimensions.
	...
	public KDTreeRadar() {
		lr = new KDTreeRadar[2];
	}
	

//	Make a new tree from a list of points.
	public static KDTreeRadar MakeFromPoints(params Vector3[] points) {
...
//	Recursively build a tree by separating points at plane boundaries.
	static KDTreeRadar MakeFromPointsInner(
					int depth,
		...
		KDTreeRadar root = new KDTreeRadar();
