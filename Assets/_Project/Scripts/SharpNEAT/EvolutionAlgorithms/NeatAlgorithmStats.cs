...
namespace SharpNeat.EvolutionAlgorithms
{
    ...
    public class NeatAlgorithmStats
    {
        ...
        #region Novelty Stats

        /// <summary>
        /// The novelty of the best genome.
        /// </summary>
        public double _maxNovelty;
        /// <summary>
        /// The mean genome fitness.
        /// </summary>
        ...
        /// The mean fitness of current specie champions.
        /// </summary>
        public double _meanSpecieChampNovelty;
        ...
        public DoubleCircularBufferWithStats _bestNoveltyMA = new DoubleCircularBufferWithStats(100);
        /// <summary>
        ...
        public DoubleCircularBufferWithStats _meanSpecieChampNoveltyMA = new DoubleCircularBufferWithStats(100);
        /// <summary>
        ...
        public double _prevBestNoveltyMA;
        /// <summary>
        ...
        public double _prevMeanSpecieChampNoveltyMA;
        /// <summary>
        ...
        public NeatAlgorithmStats(NeatEvolutionAlgorithmParameters eaParams)
        {
          //  _bestFitnessMA = new DoubleCircularBufferWithStats(eaParams.BestFitnessMovingAverageHistoryLength);
            ...
            _bestNoveltyMA = new DoubleCircularBufferWithStats(5);
            _meanSpecieChampFitnessMA = new DoubleCircularBufferWithStats(eaParams.MeanSpecieChampFitnessMovingAverageHistoryLength);
            _meanSpecieChampNoveltyMA = new DoubleCircularBufferWithStats(eaParams.MeanSpecieChampFitnessMovingAverageHistoryLength);
