...
namespace SharpNeat.Core
{
    ...
    public class EvaluationInfo
    {
        ...
        /// <summary>
        /// Gets the novelty score value to be used by the evolution algorithm for selection of genomes
        /// (for reproduction) and species fitness sharing. No novelty buffer is implemented - no need yet.
        /// </summary>
        ...
        {
            if (novelty < 0.0 || double.IsNaN(novelty) || double.IsInfinity(novelty))
            {
                throw new ArgumentOutOfRangeException("Negative novelty values are not valid.");
